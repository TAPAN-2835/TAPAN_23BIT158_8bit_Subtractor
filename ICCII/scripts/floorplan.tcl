...
create_lib -ref_lib $PDK_PATH/lib/ndm/saed32rvt_c.ndm 8_SUB_LIB

read_verilog {./../DC/results/subtractor_8bit.mapped.v} -library 8_SUB_LIB -design 8_sub -top 8_sub
